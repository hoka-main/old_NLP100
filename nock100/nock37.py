...
def main():
    ...
    removed_phrase_list = nock36.remove_items(phrase_list, '記号')
    ...
    for phrase, count in nock35.word_pop_frequency(count_list):
    ...
    nock36.plot(plot_keys, plot_items, 'graph37.png')
    # 36の関数を使ってグラフに起こす
